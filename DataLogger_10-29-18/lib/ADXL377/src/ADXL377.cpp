...
float ADXL377::readX(){
  //675 for 5v uC, 1023 for 3.3v uC
  return mapf(analogRead(xpin),0,675, -200, 200);
}


float ADXL377::readY(){
  //675 for 5v uC, 1023 for 3.3v uC
  return mapf(analogRead(ypin),0,675, -200, 200);
}


float ADXL377::readZ(){
  //675 for 5v uC, 1023 for 3.3v uC
  return mapf(analogRead(zpin),0,675, -200, 200);
}
...
float ADXL377::mapf(float x, float in_min, float in_max, float out_min, float out_max)
{
